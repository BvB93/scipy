...
from typing import overload, Dict, Tuple, List, TYPE_CHECKING
...
@overload
def find(sub: str | None = ..., disp: L[False] = ...) -> List[str]:  # type: ignore[misc]
    ...
@overload
def find(sub: str | None = ..., disp: L[True] = ...) -> None:
    ...
def find(sub: str | None = None, disp: bool = False) -> None | List[str]:
    """
